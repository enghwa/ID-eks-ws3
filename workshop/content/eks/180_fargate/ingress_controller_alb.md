...
#### Is **helm** installed?
If `helm` is not found in your shell, see [installing helm](/eks/150_spotworkers/deployhandler.html) for instructions.
...
Next, let's add helm incubator repository
